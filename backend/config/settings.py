...
EXTRACTION_MAX_ENTITIES = int(os.getenv("EXTRACTION_MAX_ENTITIES", "20"))
EXTRACTION_MAX_CLAIMS = int(os.getenv("EXTRACTION_MAX_CLAIMS", "30"))
EXTRACTION_MAX_RELATIONSHIPS = int(os.getenv("EXTRACTION_MAX_RELATIONSHIPS", "20"))
EXTRACTION_MAX_OUTPUT_TOKENS = int(os.getenv("EXTRACTION_MAX_OUTPUT_TOKENS", "2048"))
