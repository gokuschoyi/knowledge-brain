    ...
    >
      ...
      >
        ...
        <Box flex='1' minH='0' overflow='hidden'>
          <Tabs.Content value='stages' h='full' overflowY='auto' pr='1'>
            <Stack gap='2'>
          ...
          <Tabs.Content value='chunks' h='full' overflowY='auto' pr='1'>
            <Stack gap='3'>
          ...
          <Tabs.Content value='logs' h='full' overflowY='auto' pr='1'>
            <Stack gap='2'>
              {job.log.length > 0 ? (
